...
import AvailabilityAnimation, { HomeType, UserType } from '../../components/AvailabilityAnimation';
...
export default function AvailabilityScreen() {
  ...
  const [salesPersons, setSalesPersons] = useState<UserType[]>(generateSalesPersons());
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.description}>
          Using Moti and Reanimated to create skeleton loaders and entrance animations
        </Text>
        ...
        <View style={styles.buttonContainer}>
          ...
          <TouchableOpacity
            style={[styles.button, { marginTop: 12, backgroundColor: '#6200EE' }]}
